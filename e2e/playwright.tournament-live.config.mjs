...
const outputRoot = 'artifacts/playwright-tournament-live';

// Explicit opt-in only. This suite mutates the active official staging tournament
// and must never run as part of the automatic blocking staging acceptance.
export default defineConfig({
  testDir: './staging',
  testMatch: ['tournament-registration-live.spec.mjs'],
