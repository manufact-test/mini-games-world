...
test('staging app root serves integrated v123 notification and opponent graph', async ({ browser }) => {
  ...
  try {
    ...
    const required = [
      ...
      '/assets/js/screens/notifications-passive-v130.js?v=130',
      '/assets/js/notification-deeplink-toast-policy-v131.js?v=131',
    ...
    const retired = [
      ...
      '/assets/js/notification-deeplink-toast-policy-v130.js?v=130',
