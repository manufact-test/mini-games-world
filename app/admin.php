...
<head>
  ...
  <script src="./assets/js/admin-support.js?v=6&mvp22_1=admin-rework&support_focus=ticket-detail-v1&attachment_viewer=inline-v2&reply_files=managed-v1&reply_delivery=bell-v1" defer></script>
