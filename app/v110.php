...
$imports[$dominoRendererImportKey] .= '&live_effects=v35';
...
header('X-MGW-Domino-Live-Precision: local-owner-shimmer-spark-v35');
header('X-MGW-Domino-Live-Effects: precision-shimmer-stock-static-sparks-v35');
echo $html;
