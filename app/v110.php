...
<script type="importmap">
{
  "imports": {
    ...
    "./assets/js/production-v110-readonly-game-sync.js?v=1107&b=bc9d7b435f1a": "./assets/js/production-v110-readonly-game-sync.js?v=1108&clock=pending-watch-sync",
...
header('X-MGW-TTT-Clock: authoritative-turn-clock-v5-pending-watch-sync');
