...
<script type="importmap">
{
  "imports": {
    ...
    "./assets/js/games/game-card-copy.js?v=81&sk=2": "./assets/js/games/game-card-copy.js?v=82&sk=3&icons=c1efd5af"
  }
}
</script>
HTML;
...
$html = str_replace(
    ...
    './assets/js/main-v110.js?v=1138&ux=1&sk=3&icons=c1efd5af&render=4',
    $html
);
$html = str_replace(
...
header('X-MGW-Icon-Render: accepted-v4-authoritative-v110');
echo $html;