...
$checkersTelegramHeightFitTarget = './assets/css/games/checkers/telegram-height-fit-v1.css?v=4&checkers=telegram-scroll-c14';
...
if ($isStagingRuntimeProbe) {
    $runtimeProbeTag = '<div id="mgw-staging-runtime-probe" style="position:fixed;top:max(4px,env(safe-area-inset-top));left:4px;z-index:2147483647;padding:3px 6px;border-radius:6px;background:#ff2d55;color:#fff;font:700 10px/1.1 monospace;letter-spacing:.02em;pointer-events:none;box-shadow:0 1px 4px rgba(0,0,0,.4)">STG A1 · v110 · C14</div>';
...
if ($isStagingRuntimeProbe) {
    header('X-MGW-Staging-Runtime-Probe: stg-a1-v110-c14');
}
echo $html;
