...
import { initProfileBattleshipParity } from './mgw-profile-battleship-parity.js?v=13&mvp19_12=profile-four-parity-v3&store=preview-parity-v13&geometry=square&header=steel-ship&neon_fleet=tube-v4&fleet_preview=svg-models-v3&neon_map_ships=white-v1&preview_geometry=svg-circles-v6&hydration=observer-v1&inline_owner=svg-v5&effects=live-parity-shot-v2&copy=four-pattern';
