...
import { initProfileBattleshipParity } from './mgw-profile-battleship-parity.js?v=8&mvp19_12=profile-four-parity-v3&store=preview-parity-v8&geometry=square&header=steel-ship&neon_fleet=tube-v4&fleet_preview=scale-parity-v1&preview_geometry=inline-square-v3&hydration=observer-v1&inline_owner=v2&effects=unchanged-v2&copy=four-pattern';
