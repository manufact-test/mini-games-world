...
import { initProfileBattleshipParity } from './mgw-profile-battleship-parity.js?v=10&mvp19_12=profile-four-parity-v3&store=preview-parity-v10&geometry=square&header=steel-ship&neon_fleet=tube-v4&fleet_preview=svg-models-v3&preview_geometry=svg-circles-v5&hydration=observer-v1&inline_owner=svg-v4&effects=unchanged-v2&copy=four-pattern';
