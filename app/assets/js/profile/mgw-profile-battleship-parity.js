...
import { battleshipPreviewMarkup } from '../screens/store-screen-battleship-store-v1.js?v=8&mvp19_12=store-preview-parity-v8&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&fleet_preview=scale-parity-v1&preview_geometry=inline-square-v3&hydration=observer-v1&inline_owner=v2&effects=unchanged-v2';
...
function ensureBattleshipProfileStyles(){
  ensureStyle(
    ...
    '../../css/games/battleship/store-cosmetics-v1.css?v=8&mvp19_12=store-preview-parity-v8&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&fleet_preview=scale-parity-v1&preview_geometry=inline-square-v3&hydration=observer-v1&inline_owner=v2&effects=unchanged-v2'
  );
  ensureStyle(
