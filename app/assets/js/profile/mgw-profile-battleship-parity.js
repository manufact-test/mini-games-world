...
import { battleshipPreviewMarkup } from '../screens/store-screen-battleship-store-v1.js?v=6&mvp19_12=store-preview-parity-v6&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&preview_geometry=square-grid-v2&hydration=observer-v1&effects=unchanged-v2';
...
function ensureBattleshipProfileStyles(){
  ensureStyle(
    ...
    '../../css/games/battleship/store-cosmetics-v1.css?v=6&mvp19_12=store-preview-parity-v6&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&preview_geometry=square-grid-v2&hydration=observer-v1&effects=unchanged-v2'
  );
  ensureStyle(
