...
import { clearGameView } from './screens/game-screen-v100-safe.js?v=100';
...
export function initV101ResultSpeed(){
...
function openFinishedResult(game, me){
  ...
  if (!id || runtime.resultOpened.has(id)) return;
  ...
  openSheet(`
    <div class="sheet-head">
      <div><h2>${escapeHtml(title)}</h2><p>${escapeHtml(text)}</p></div>
