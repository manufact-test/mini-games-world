window.__MGW_BUILD__ = 'v101-mvp14-global-speed';
...
import { initGameScreen, enterGame } from './screens/game-screen-v100-safe.js?v=100';
...
import { initGameInvites, openIncomingInviteIfPresent } from './games/game-invites.js?v=d1';
...
/* Keep the reviewed v100 search/game implementation unchanged. */
initGameScreen();
initGameInvites();
initSearchScreen();
