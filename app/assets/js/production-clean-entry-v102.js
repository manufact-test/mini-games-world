...
window.__MGW_REGRESSION_BUILD__ = 'v102-mvp14-targeted-regression-repair';

/* Identity and secondary-device protection remain outermost and unchanged. */
initSessionOwnershipFix();
initV99SessionTransport();
initV99ExplicitLockGuard();

/* Keep the accepted v101 speed layer; replace only the reported target owners. */
initV101PollTuning();
...
/* Visual-only helpers remain unchanged. */
