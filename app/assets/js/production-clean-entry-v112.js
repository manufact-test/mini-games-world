...
import { initV112InstantLaunchOverlay } from './production-v112-instant-launch-overlay.js?v=112';
...
window.__MGW_REGRESSION_BUILD__ = 'v112-mvp14r2-instant-launch-overlay';

// v112 keeps the accepted v110 owners unchanged and adds only one visual
// transition owner. It does not own server readiness, game rules or clocks.
initV112InstantLaunchOverlay();
