...
function gameCosmeticDescription(gameType, layer, variant){
  if (gameType === 'chess') {
    ...
    if (layer === 'elements') return ({ wood:'Янтарные и тёмно-вишнёвые фигуры, заметно отличающиеся от базового набора', marble:'Светлые мраморные фигуры', metal:'Полированные металлические фигуры', neon:'Фигуры с ярким неоновым контуром' })[variant] || 'Меняет внешний вид шахматных фигур';
  ...
  if (gameType === 'domino') {
    if (layer === 'theme') return ({ felt:'Глубокое бордовое сукно с винной кромкой вместо стандартного зелёного стола', midnight:'Тёмно-синий стол с холодной подсветкой и спокойным клубным настроением', walnut:'Тёплый ореховый стол с цельной древесной игровой поверхностью и живой фактурой', neon:'Глубокий тёмный стол с цианово-фиолетовой неоновой кромкой' })[variant] || 'Меняет оформление игрового стола';
    if (layer === 'elements') return ({ ivory:'Тёплые янтарные костяшки с тёмными точками вместо стандартных светлых', ebony:'Чёрные матовые костяшки классической формы со светлыми точками', marble:'Мраморные костяшки с натуральной минеральной фактурой и чёткими точками', neon:'Тёмные костяшки с яркими неоновыми точками и тонким контуром' })[variant] || 'Меняет внешний вид костяшек';
