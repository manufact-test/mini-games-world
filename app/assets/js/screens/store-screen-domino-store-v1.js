...
function descriptionFor(layer, variant){
  if (layer === 'theme') {
    return ({
      felt:'Глубокое бордовое сукно с винной кромкой вместо стандартного зелёного стола',
  ...
  if (layer === 'elements') {
    return ({
      ivory:'Тёплые янтарные костяшки с тёмными точками вместо стандартных светлых',
