...
import { initV105FastNotifications } from './production-v105-fast-notifications.js?v=1051';
...
window.__MGW_REGRESSION_BUILD__ = 'v105-mvp14-emergency-rollback-fast-notifications';

// Register only the instant notification-open owner before the retained app graph.
// It does not own pointer or swipe events.
initV105FastNotifications();
