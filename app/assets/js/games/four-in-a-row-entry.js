...
import { startGamePolling } from '../screens/game-screen.js?v=49';
...
function openFourInARowSetup(){
  ...
  openSheet(`
    <div class="sheet-head">
      <div><h2>4 в ряд</h2><p>${roomName(state.room)}. Поле 7×6${isGold ? ' — выберите стоимость участия' : ''}.</p></div>
    ...
    <div class="setup-scroll">
      ...
      <div class="four-setup-preview" aria-hidden="true">
        <span></span><span></span><span></span><span></span><span></span><span></span><span></span>
        <span></span><span></span><span></span><span></span><span></span><span></span><span></span>
        <span></span><span></span><span></span><span class="yellow"></span><span></span><span></span><span></span>
        <span></span><span></span><span class="red"></span><span class="yellow"></span><span></span><span></span><span></span>
        <span></span><span class="red"></span><span class="yellow"></span><span class="red"></span><span></span><span></span><span></span>
        <span class="yellow"></span><span class="red"></span><span class="yellow"></span><span class="red"></span><span></span><span></span><span></span>
      </div>
...
async function startFourInARowSearch(){
  ...
  try {
    closeSheet();
    const result = await api.startSearch(state.room, bet, 7, 'four_in_a_row');
    ...
    if (info) info.textContent = `4 в ряд · ${roomName(state.room)} · участие ${bet} коинов · поле 7×6`;
    showScreen('search');
    startSearchPolling();
  } catch (error) {
    toast(error.message);
