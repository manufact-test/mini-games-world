...
function ensureLiveStyles(){
  ...
  const href = new URL('../../../css/games/battleship/live-cosmetics-v1.css?v=4&mvp19_12=live-maps-fleets-v4&frame=full-v1&neon_fleet=tube-v4', import.meta.url).href;
  const existing = document.querySelector('link[data-mgw-battleship-live-cosmetics]');
  if (existing instanceof HTMLLinkElement) {
    if (existing.href !== href) existing.href = href;
    existing.dataset.mgwBattleshipLiveCosmetics = 'maps-fleets-v4';
    return;
  }

  const link = document.createElement('link');
  link.rel = 'stylesheet';
  link.dataset.mgwBattleshipLiveCosmetics = 'maps-fleets-v4';
  link.href = href;
