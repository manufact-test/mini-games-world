import {
  ...
  battleshipStatus,
} from './renderer.js?v=60&shot=miss-no-impact&base=mvp19_12-live-maps-fleets-v3';
...
export function renderBattleshipSurface(args){
  ...
  container.dataset.mgwBattleshipLiveCosmetics = 'maps-fleets-v3';
...
function ensureLiveStyles(){
  ...
  const href = new URL('../../../css/games/battleship/live-cosmetics-v1.css?v=3&mvp19_12=live-maps-fleets-v3&frame=full-v1&neon_fleet=flat-v3', import.meta.url).href;
  const existing = document.querySelector('link[data-mgw-battleship-live-cosmetics]');
  if (existing instanceof HTMLLinkElement) {
    if (existing.href !== href) existing.href = href;
    existing.dataset.mgwBattleshipLiveCosmetics = 'maps-fleets-v3';
    return;
  }

  const link = document.createElement('link');
  link.rel = 'stylesheet';
  link.dataset.mgwBattleshipLiveCosmetics = 'maps-fleets-v3';
  link.href = href;
