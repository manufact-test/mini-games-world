window.__MGW_BUILD__ = 'v65-reversi-client';
...
import { initSearchScreen } from './screens/search-screen.js?v=65';
import { initGameScreen, startGamePolling } from './screens/game-screen.js?v=65';
import { initProfileScreen } from './screens/profile-screen.js?v=48';
import { initGameRules } from './games/game-rules.js?v=65';
import { initGameCardCopy } from './games/game-card-copy.js?v=65';
import { initGameInvites } from './games/game-invites.js?v=55';
import { initTicTacToeEntry } from './games/tictactoe/entry.js?v=65';
import { initFourInARowEntry } from './games/four-in-a-row/entry.js?v=65';
import { initBattleshipEntry } from './games/battleship/entry.js?v=65';
import { initCheckersEntry } from './games/checkers/entry.js?v=65';
import { initReversiEntry } from './games/reversi/entry.js?v=65';
