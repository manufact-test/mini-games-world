window.__MGW_BUILD__ = 'v66-reversi-ux-fix';
...
import { initSearchScreen } from './screens/search-screen.js?v=66';
import { initGameScreen, startGamePolling } from './screens/game-screen.js?v=66';
import { initProfileScreen } from './screens/profile-screen.js?v=48';
import { initGameRules } from './games/game-rules.js?v=66';
import { initGameCardCopy } from './games/game-card-copy.js?v=65';
import { initGameInvites } from './games/game-invites.js?v=55';
import { initTicTacToeEntry } from './games/tictactoe/entry.js?v=66';
import { initFourInARowEntry } from './games/four-in-a-row/entry.js?v=66';
import { initBattleshipEntry } from './games/battleship/entry.js?v=66';
import { initCheckersEntry } from './games/checkers/entry.js?v=66';
import { initReversiEntry } from './games/reversi/entry.js?v=66';
