window.__MGW_BUILD__ = 'v53-battleship';
...
import { initSearchScreen } from './screens/search-screen.js?v=53';
import { initGameScreen, startGamePolling } from './screens/game-screen.js?v=53';
import { initProfileScreen } from './screens/profile-screen.js?v=48';
import { initGameRules } from './games/game-rules.js?v=53';
import { initGameCardCopy } from './games/game-card-copy.js?v=53';
import { initTicTacToeEntry } from './games/tictactoe/entry.js?v=53';
import { initFourInARowEntry } from './games/four-in-a-row/entry.js?v=53';
import { initBattleshipEntry } from './games/battleship/entry.js?v=53';
