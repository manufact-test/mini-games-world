window.__MGW_BUILD__ = 'v52-game-modules';
...
import { initSearchScreen } from './screens/search-screen.js?v=52';
import { initGameScreen, startGamePolling } from './screens/game-screen.js?v=52';
import { initProfileScreen } from './screens/profile-screen.js?v=48';
import { initGameRules } from './games/game-rules.js?v=52';
import { initGameCardCopy } from './games/game-card-copy.js?v=52';
import { initTicTacToeEntry } from './games/tictactoe/entry.js?v=52';
import { initFourInARowEntry } from './games/four-in-a-row/entry.js?v=52';
