window.__MGW_BUILD__ = 'v73-domino-ux';
...
import { renderRoomCard, initHomeScreen, setRoom, renderStats } from './screens/home-screen.js?v=73';
...
import { initSearchScreen } from './screens/search-screen.js?v=73';
import { initGameScreen, startGamePolling } from './screens/game-screen.js?v=73';
import { initProfileScreen } from './screens/profile-screen.js?v=48';
import { initGameRules } from './games/game-rules.js?v=73';
import { initGameCardCopy } from './games/game-card-copy.js?v=72';
import { initGameInvites } from './games/game-invites.js?v=55';
import { initTicTacToeEntry } from './games/tictactoe/entry.js?v=73';
import { initFourInARowEntry } from './games/four-in-a-row/entry.js?v=73';
import { initBattleshipEntry } from './games/battleship/entry.js?v=73';
import { initCheckersEntry } from './games/checkers/entry.js?v=73';
import { initReversiEntry } from './games/reversi/entry.js?v=73';
import { initChessEntry } from './games/chess/entry.js?v=73';
import { initGoEntry } from './games/go/entry.js?v=73';
import { initDominoEntry } from './games/domino/entry.js?v=73';
