...
import { initV111SyncedMatchStart } from './production-v111-synced-match-start.js?v=111';
...
window.__MGW_REGRESSION_BUILD__ = 'v111-mvp14r2-synced-match-start-clock';

// v110 remains the accepted owner of notification/search/mobile TTT fixes.
// v111 adds one shared preparation/readiness and authoritative clock owner for
// all game types without restoring the failed v106-v108 client runtime chain.
initV110AcceptanceRuntime();
initV111SyncedMatchStart();
