...
return [
    ...
    'imports' => [
        ...
        './assets/js/screens/store-screen.js?v=34' => './assets/js/screens/store-screen-intent-wrapper.js?v=1&mobile=intent-only&mobile_scope=all&first_paint=preloader-primed-final-v1&first_refresh=single-render-v1&profile_first=settled-before-store-intent-v3',
