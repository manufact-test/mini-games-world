...
return [
    ...
    'imports' => [
        ...
        './assets/js/profile/mgw-profile-reactions.js?v=2&mvp19_3=ingame-corrective-base' => './assets/js/profile/mgw-profile-reactions.js?v=4&mvp19_3=ingame-smooth-corrective&first_frame=primed-v4',
        './assets/js/main-v110-handoff-shell.js?v=1137&ux=1&sk=3&icons=c1efd5af&render=5' => './assets/js/main-v110-handoff-shell.js?v=1155&mvp18=friend-request-lifecycle&store=post-boot-warm&profile-nav=paint-before-open-v1',
    ...
    'assets' => [
        ...
        'consistency_css' => './assets/css/production-v98-mobile-profile-perf.css?v=3&mvp19_3=reaction-header-square-smooth&profile=mobile-perf-v2&profile2=route-first-frame-v3&reaction=first-frame-v3&profile3=active-refresh-remount-v4&profile4=paint-cached-first-v5&header=metal-parity-v2',
