...
return [
    ...
    'imports' => [
        '@mgw/clean-entry' => './assets/js/production-clean-entry-v110-mvp19-3-final-polish-mobile-nav-v2.js?v=1&profile_route_guard=animation-runtime-v2',
        ...
        './assets/js/ui.js?v=89' => './assets/js/ui.js?v=97&mvp16=canonical-profile-display-owner&mvp19=mgw-avatar-only&mvp19_3_1=selected-avatar-owner&c7=no-prehydrate-default&mvp19_3_4=name-color-chrome',
        ...
        './assets/js/components/toast.js?v=27' => './assets/js/components/toast.js?v=29&store=quiet-cosmetic-equip-all',
        './assets/js/components/toast.js?v=41' => './assets/js/components/toast.js?v=29&store=quiet-cosmetic-equip-all',
        './assets/js/components/account-shortcuts.js?v=48' => './assets/js/components/account-shortcuts.js?v=53&mvp18=friends-corrective&optimistic-relations',
        ...
        './assets/js/screens/store-screen.js?v=34' => './assets/js/screens/store-screen-intent-wrapper.js?v=1&mobile=intent-only&mobile_scope=all&first_paint=preloader-primed-final-v1&first_refresh=single-render-v1&profile_first=settled-before-store-intent-v3&first_visible=consume-prime-no-refresh-v1&mvp19_5=chess-catalog&fx_preview=move-live-parity-v4&copy=human-v2&board_preview=native-static-v1&post_action_preview=effect-only-v1&quantum_echo=preview-v1&rev=18',
        './assets/js/screens/profile-screen-v110.js?v=1108' => './assets/js/profile/mgw-profile-chess-layout-v2.js?v=3&mvp16=profile-pass-a&mvp17=result-history-economy&mvp19=avatar-collection&previsual=instant-equip&mvp19_3_1=avatar-sync&mvp19_3_2=game-cosmetics&mvp19_3_3=game-tabs-fresh&mvp19_3_4=name-colors&perf=stable-render-cache&active_refresh=deferred-remount-v1&entry=paint-cached-first-v1&mobile_lifecycle=yield-refresh-and-remount-v1&mvp19_5=chess-profile-store-parity-v1&layout=card-sheet-fit-v2&secondary=clean-v1&game_tabs=panel-only-v1&mobile_perf=hidden-animations-paused-v1',
        './assets/js/screens/profile-screen-v110.js?v=1126&profile_base=accepted-game-cosmetics' => './assets/js/screens/profile-screen-v110.js?v=1127&mvp16=profile-pass-a&mvp17=result-history-economy&mvp19=avatar-collection&previsual=instant-equip&mvp19_3_1=avatar-sync&mvp19_3_2=game-cosmetics&mvp19_3_3=game-tabs-panel-only-v1&mvp19_3_4=name-colors&perf=stable-render-cache&active_refresh=deferred-remount-v1&entry=paint-cached-first-v1&mobile_lifecycle=yield-refresh-and-remount-v1',
        ...
        './assets/js/profile/mgw-profile-victory-effects.js?v=1&mvp19_3=victory-effects' => './assets/js/profile/mgw-profile-victory-effects-card-parity.js?v=11&mvp19_3=victory-nova&visual_repair=11&profile_card_sheet_final=8&preview=on-demand-v2',
        ...
        './assets/js/production-v110-readonly-game-sync.js?v=1107&b=bc9d7b435f1a' => './assets/js/production-v110-readonly-game-sync.js?v=1116&terminal=nonblocking-watch&mvp19_3=reactions&entry_effects=1&victory_effects=spark-burst-card-parity-v3',
    ...
    'assets' => [
        ...
        'bootstrap' => './assets/js/app-bootstrap-v2.js?v=10&mvp16=version-manifest&entry_v8=entry01-strike-entry02-royal-ascension-entry03-lord-entrance-v6&victory=victory-nova&visual_repair=11&profile_card_sheet_final=8&mvp19_5=native-board-preview-v1',
    ],
