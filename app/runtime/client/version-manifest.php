...
return [
    ...
    'imports' => [
        ...
        './assets/js/screens/store-screen.js?v=34' => './assets/js/screens/store-screen-intent-wrapper.js?v=1&mobile=intent-only&profile_first=quiet-prewarm-v1',
        ...
        './assets/js/profile/mgw-profile-reactions.js?v=2&mvp19_3=ingame-corrective-base' => './assets/js/profile/mgw-profile-reactions.js?v=5&mvp19_3=ingame-smooth-corrective&first_frame=primed-v4&profile_nav=canonical-pointer-v2&route_work=game-only-v1',
        './assets/js/main-v110-handoff-shell.js?v=1137&ux=1&sk=3&icons=c1efd5af&render=5' => './assets/js/main-v110-handoff-shell.js?v=1155&mvp18=friend-request-lifecycle&store=post-boot-warm&profile=boot-prepared-direct-route-v1&profile_first=background-raster-prewarm-v1&prewarm_order=store-ready-v1',
    ...
    'assets' => [
        ...
        'consistency_css' => './assets/css/production-v99-profile-reaction-polish.css?v=1&mvp19_3=reaction-card-polish&purchase=pending-feedback&compat=production-v98-mobile-profile-perf.css?v=6&mvp19_3=reaction-header-square-smooth&profile8=scroll-layer-route-v1&profile9=no-active-subtree-invalidation-v1&profile10=idle-prepaint-first-viewport-v1&profile11=covered-active-raster-prewarm-v1&header=metal-parity-v2',
