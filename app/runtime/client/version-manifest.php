...
return [
    ...
    'imports' => [
        ...
        './assets/js/screens/store-screen.js?v=34' => './assets/js/screens/store-screen-intent-wrapper.js?v=2&mobile=safe-post-profile-warm&profile_first=settled-before-store-warm-v2&first_paint=ready-gate-v1',
        ...
        './assets/js/main-v110-handoff-shell.js?v=1137&ux=1&sk=3&icons=c1efd5af&render=5' => './assets/js/main-v110-handoff-shell.js?v=1158&mvp18=friend-request-lifecycle&store=post-profile-safe-warm-v2&profile=boot-prepared-direct-route-v1&profile_first=background-raster-prewarm-v1&tournaments=active-raster-prewarm-v1&store_first=hidden-ready-gate-v1',
