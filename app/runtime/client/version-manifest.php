...
return [
    ...
    'imports' => [
        ...
        './assets/js/screens/store-screen.js?v=34' => './assets/js/screens/store-screen-intent-wrapper.js?v=1&mobile=intent-only&mobile_scope=all&first_paint=hidden-ready-gate-v2&first_refresh=single-render-v1&profile_first=settled-before-store-intent-v3',
        ...
        './assets/js/main-v110-handoff-shell.js?v=1137&ux=1&sk=3&icons=c1efd5af&render=5' => './assets/js/main-v110-handoff-shell.js?v=1155&mvp18=friend-request-lifecycle&store=post-boot-warm&profile=boot-prepared-direct-route-v1&profile_first=background-raster-prewarm-v1&tournaments=active-raster-prewarm-v1&store_first=hidden-ready-gate-v1&store_warm=post-profile-safe-v2',
    ...
    'assets' => [
        ...
        'consistency_css' => './assets/css/production-v99-profile-reaction-polish.css?v=2&mvp19_3=cumulative-reaction-cards&layout=bounded-packs&owned=passive-status&profile_nav=direct-sync-v2&row_footer=stretch-v1&pack4=single-row-v1&profile_first=structural-route-guard-v1',
