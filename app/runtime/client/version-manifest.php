...
return [
    ...
    'imports' => [
        ...
        './assets/js/api/client.js?v=34' => './assets/js/api/client.js?v=1134&mvp16=profile-corrective&mvp17=history-fresh-match&menu=fast-history',
        './assets/js/api/client.js?v=38' => './assets/js/api/client.js?v=1134&mvp16=profile-corrective&mvp17=history-fresh-match&menu=fast-history',
        './assets/js/api/client.js?v=46' => './assets/js/api/client.js?v=1134&mvp16=profile-corrective&mvp17=history-fresh-match&menu=fast-history',
        './assets/js/api/client.js?v=47' => './assets/js/api/client.js?v=1134&mvp16=profile-corrective&mvp17=history-fresh-match&menu=fast-history',
