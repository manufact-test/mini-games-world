...
return [
    ...
    'imports' => [
        '@mgw/clean-entry' => './assets/js/production-clean-entry-v110.js?v=1125&mvp16=canonical-avatar-owner&mvp17=history-single-owner&mvp19=avatar-presentation',
        ...
        './assets/js/api/client.js?v=38' => './assets/js/api/client.js?v=1134&mvp16=profile-corrective&mvp17=history-fresh-match&menu=fast-history&result=locked-watch&mvp18=friends&mvp19=store-v2',
        './assets/js/api/client.js?v=46' => './assets/js/api/client.js?v=1134&mvp16=profile-corrective&mvp17=history-fresh-match&menu=fast-history&result=locked-watch&mvp18=friends&mvp19=store-v2',
        './assets/js/api/client.js?v=47' => './assets/js/api/client.js?v=1134&mvp16=profile-corrective&mvp17=history-fresh-match&menu=fast-history&result=locked-watch&mvp18=friends&mvp19=store-v2',
        './assets/js/config.js?v=38' => './assets/js/config.js?v=39&mvp15=match-economy',
        './assets/js/state.js?v=27' => './assets/js/state.js?v=30&mvp16=router-lifecycle&mvp19=profile-inventory',
        './assets/js/router.js?v=27' => './assets/js/router.js?v=30&b=871cb833d99d&mvp16=route-registry&mvp18=friends',
        './assets/js/ui.js?v=89' => './assets/js/ui.js?v=94&mvp16=canonical-profile-display-owner&mvp19=mgw-avatar-only',
        ...
        './assets/js/screens/store-screen.js?v=34' => './assets/js/screens/store-screen.js?v=38&mvp16=primary-tab&mvp19=store-v2&corrective=2',
        './assets/js/screens/profile-screen-v110.js?v=1108' => './assets/js/screens/profile-screen-v110.js?v=1118&mvp16=profile-pass-a&mvp17=result-history-economy&mvp19=avatar-collection&previsual=instant-equip',
    ...
    'assets' => [
        'main_css' => './assets/css/main.css?v=174&sk=3&icons=c1efd5af&render=37&mvp16=notification-center-v2-desktop-cache&mvp19=store-v2&corrective=2&avatar=profile-v1',
