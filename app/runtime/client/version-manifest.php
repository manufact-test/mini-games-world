...
return [
    ...
    'imports' => [
        ...
        './assets/js/screens/store-screen.js?v=34' => './assets/js/screens/store-screen-intent-wrapper.js?v=2&mobile=intent-only-all&first_paint=hidden-ready-gate-v2&first_refresh=single-render-v1&profile_first=settled-before-store-intent-v3',
