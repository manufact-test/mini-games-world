...
return [
    ...
    'imports' => [
        ...
        './assets/js/games/game-rules.js?v=75' => './assets/js/games/game-rules.js?v=76&mvp16=variant-rules',
        './assets/js/games/unified-game-launcher.js?v=1&mvp16=unified-game-setup' => './assets/js/games/unified-game-launcher.js?v=4&mvp16=ttt-variant-rules',
    ...
    'assets' => [
        'main_css' => './assets/css/main.css?v=161&sk=3&icons=c1efd5af&render=30&mvp16=ttt-variant-rules',
