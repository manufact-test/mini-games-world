...
return [
    ...
    'imports' => [
        ...
        './assets/js/screens/store-screen.js?v=34' => './assets/js/screens/store-screen-intent-wrapper.js?v=1&mobile=intent-only-active-game&normal_mobile=post-profile-safe-warm-v2&profile_first=settled-before-store-warm-v2&first_paint=ready-gate-v1',
