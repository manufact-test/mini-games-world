...
$html = str_replace(
    ...
    './assets/js/main.js?v=d2-unified-wallet-15-3-r1743',
    $html
);

$mainScript = '<script type="module" src="./assets/js/main.js?v=d2-unified-wallet-15-3-r1743"></script>';
...
header('Pragma: no-cache');
header('Expires: 0');
header('X-MGW-Frontend-Build: d2-unified-wallet-15-3-r1743');
