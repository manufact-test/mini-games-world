...
$notificationWindowOwner = '<script type="module" src="./assets/js/screens/notification-window-owner-v124.js?v=124"></script>';
...
<script type="importmap">
{
  "imports": {
    ...
    "./assets/js/screens/notifications-screen-v99.js?v=99": "./assets/js/screens/notifications-passive-v124.js?v=124",
...
$html = str_replace(
    ...
    'data-hotfix-build="v124-mvp14-d1-live-failure-fixes"',
    $html
);
$html = str_replace(
...
header('Expires: 0');
header('X-MGW-Frontend-Build: v124-mvp14-d1-live-failure-fixes');
echo $html;