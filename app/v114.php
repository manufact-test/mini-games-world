...
$html = str_replace(
    ...
    'data-hotfix-build="d1-canonical-owners"',
    $html
);
$html = str_replace(
    './assets/js/main.js?v=98.3',
    './assets/js/main.js?v=132',
    $html
);

$mainScript = '<script type="module" src="./assets/js/main.js?v=132"></script>';
...
header('Expires: 0');
header('X-MGW-Frontend-Build: d1-canonical-owners');
echo $html;
