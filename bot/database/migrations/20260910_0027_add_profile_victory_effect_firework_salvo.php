...
return new class implements DatabaseMigrationInterface {
    ...
    private const ITEM_ID = 'profile-victory-effect-02';
    private const OFFER_ID = 'victory-effect-02';
    private const PRICE = 8500;
    private const DURATION_MS = 2900;

    public function version(): string
    {
        return '20260910_0027_add_profile_victory_effect_firework_salvo';
    }

    public function description(): string
    {
        return 'Seed MVP-19.3 Victory Effect II: Firework Salvo.';
    }
