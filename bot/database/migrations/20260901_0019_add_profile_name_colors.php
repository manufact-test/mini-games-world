...
return new class implements DatabaseMigrationInterface {
    private const SLOT = 'profile_name_color';
    ...
    {
        return '20260901_0019_add_profile_name_colors';
    }

    public function description(): string
    {
        return 'Seed the canonical MVP-19.3 profile name-color catalogue and Store offers.';
    }
    ...
    private function ensureCatalogItem(
        ...
        $database->execute(
            "UPDATE mgw_product_catalog
             SET item_type = 'profile', item_family = 'name_color', equip_slot = :equip_slot,
    ...
    private function ensureOffer(
        ...
        $database->execute(
            "UPDATE mgw_product_offers
             SET offer_type = 'item', item_id = :item_id, category = 'profile', subcategory = 'name_color',
