...
return new class implements DatabaseMigrationInterface {
    ...
    private const ITEM_ID = 'profile-victory-effect-01';
    private const OFFER_ID = 'victory-effect-01';
    private const PRICE = 5000;
    private const DURATION_MS = 2200;

    public function version(): string
    {
        return '20260909_0026_add_profile_victory_effect_spark_burst';
    }

    public function description(): string
    {
        return 'Seed MVP-19.3 Victory Effect I: Spark Burst.';
    }
