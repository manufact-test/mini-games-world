...
return new class implements DatabaseMigrationInterface {
    ...
    {
        return 'Create explicit immutable-account ownership mapping before provider identity linking.';
    }
...
CREATE TABLE IF NOT EXISTS mgw_account_ownership (
    ...
    UNIQUE KEY uq_mgw_account_ownership_mgw (mgw_id),
    UNIQUE KEY uq_mgw_account_ownership_legacy (legacy_user_id),
    INDEX idx_mgw_account_ownership_status (ownership_status, verified_at_utc),
    CONSTRAINT chk_mgw_account_ownership_status CHECK (ownership_status IN ('active')),
...
CREATE TABLE IF NOT EXISTS mgw_account_ownership (
    ...
    mgw_id TEXT NOT NULL UNIQUE,
    legacy_user_id TEXT NOT NULL UNIQUE,
    ownership_status TEXT NOT NULL DEFAULT 'active' CHECK (ownership_status IN ('active')),
