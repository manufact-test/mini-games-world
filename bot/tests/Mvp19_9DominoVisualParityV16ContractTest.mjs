...
expect(launch.includes("/app/v110.php?v=1171"), 'Telegram entry must be cache-busted to v1171');
...
expect(!/\banimation\s*:/.test(parity), 'v16 visual parity skin must not take animation choreography ownership');

expect(choreography.includes('mgw-domino-v15-precision-flight'), 'v15 precision choreography must remain the animation owner');
expect(choreography.includes('mgw-domino-v15-stock-flight'), 'v15 stock choreography must remain the animation owner');
expect(choreography.includes('mgw-domino-v15-cascade-tile'), 'v15 cascade choreography must remain the animation owner');
