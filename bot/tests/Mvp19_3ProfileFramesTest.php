...
$assertTrue(str_contains($frameSource, "framePreviewMarkup(itemId, 'profile-v2-collection-avatar'") && str_contains($frameSource, 'profile-v2-collection-grid') && str_contains($frameSource, 'profile-v2-collection-card'), 'Profile frame collection must reuse the canonical rounded-square avatar collection presentation');
