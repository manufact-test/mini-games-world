...
expect(mainCss.includes('profile-corrective.css?v=6&mvp19=profile-collection&mvp19_3=game-tabs&fresh-selection'), 'active CSS graph must publish compact game tabs');
