...
$assertTrue(str_contains($manifest, 'mgw-profile-reactions-header.js?v=5&mvp19_3=header-square-smooth&mobile=stable-bubble-canonical-profile-nav&profile_nav=canonical-pointer-v2') && str_contains($manifest, 'mgw-profile-reactions.js?v=5&mvp19_3=ingame-smooth-corrective&first_frame=primed-v4&profile_nav=canonical-pointer-v2&route_work=game-only-v1') && str_contains($manifest, 'main-v110-handoff-shell.js?v=1155&mvp18=friend-request-lifecycle&store=post-boot-warm&profile=boot-prepared-direct-route-v1&profile_first=background-raster-prewarm-v1') && str_contains($manifest, 'production-v98-mobile-profile-perf.css?v=6&mvp19_3=reaction-header-square-smooth') && str_contains($manifest, 'profile8=scroll-layer-route-v1') && str_contains($manifest, 'profile9=no-active-subtree-invalidation-v1') && str_contains($manifest, 'profile10=idle-prepaint-first-viewport-v1') && str_contains($manifest, 'profile11=covered-active-raster-prewarm-v1') && str_contains($manifest, 'header=metal-parity-v2') && str_contains($manifest, 'entry=paint-cached-first-v1'), 'Covered first-open Profile raster and canonical direct shell route must be cache-published without changing accepted reaction owners');
