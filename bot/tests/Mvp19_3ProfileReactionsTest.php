...
$assertTrue(str_contains($manifest, 'mgw-profile-reactions.js?v=4&mvp19_3=ingame-smooth-corrective&first_frame=primed-v4&profile_nav=press-feedback-v1') && str_contains($manifest, 'main-v110-handoff-shell.js?v=1154&mvp18=friend-request-lifecycle&store=post-boot-warm') && str_contains($manifest, 'production-v98-mobile-profile-perf.css?v=3&mvp19_3=reaction-header-square-smooth') && str_contains($manifest, 'header=metal-parity-v2') && str_contains($manifest, 'profile4=paint-cached-first-v5') && str_contains($manifest, 'entry=paint-cached-first-v1'), 'Corrected first reaction and bounded Profile press feedback must be cache-published without changing the shared shell owner');
