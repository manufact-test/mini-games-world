...
$assert(str_contains($entry, $build)
    ...
    'The integrated task must publish the final production build identity.');
$assert(str_contains($shell, 'notifications-screen-v110r12.js?v=1119')
...
$assert(str_contains($php, 'production-clean-entry-v110.js?v=1119')
    ...
    'Telegram and browser entrypoints must use the final outer revision.');
