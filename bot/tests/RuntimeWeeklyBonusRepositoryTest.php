...
require $root . '/realtime/RuntimeRealtimeIdentityTrait.php';
require $root . '/realtime/RuntimeRealtimeValueTrait.php';
require $root . '/realtime/RuntimeRealtimeSourceTrait.php';
require $root . '/realtime/RuntimeRealtimeDatabaseTrait.php';
