...
$assert($toastStart !== false
    ...
    'The retained rollback notification owner must still preserve its accepted cached-first rendering contract.');
...
$assert(str_contains($launch, '/app/v110.php?v=1120'),
    'Telegram launches must use the current R12 outer revision.');
