...
$assertContains("v89-mvp14-avatar-invite-regression-hotfix", $main, 'Main module must publish hotfix build');
$assertContains("./ui.js?v=89", $main, 'Main module must cache-bust avatar renderer');
$assertContains("./screens/profile-screen.js?v=89", $main, 'Main module must cache-bust profile screen');
$assertContains('main.css?v=89', $index, 'Entrypoint must cache-bust hotfix CSS');
$assertContains('main.js?v=89', $index, 'Entrypoint must cache-bust hotfix JavaScript');
