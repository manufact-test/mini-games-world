...
if (!is_string($index) || !is_string($entry) || !is_string($main)) throw new RuntimeException('Missing v131 main entry source.');
$assertions = 0;
...
$assert(substr_count($entry, 'notification-window-owner-v121.js?v=121') === 1
    ...
    && !str_contains($entry, 'notification-window-owner-v119.js?v=119'), 'The cache-busted shell must publish v121 ownership, passive v130 and non-recursive deep-link policy v131.');
