...
$assertTrue(str_contains($wrapper, 'initBaseVictoryEffects()') && str_contains($wrapper, 'production-v110-victory-effects-card-parity.css?v=3'), 'Victory card parity must wrap the accepted live owner and cache-publish the repair');
