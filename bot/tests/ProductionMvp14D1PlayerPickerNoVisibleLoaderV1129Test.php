...
$assert(str_contains($v110, 'main-v110.js?v=1132') && str_contains($main, 'main-v110-handoff-shell.js?v=1132') && str_contains($shell, 'game-invites-v110.js?v=1130'), 'Ordinary Start must publish the no-loader owner through a fresh v1130 chain.');
