...
$assertContains("@import url('./components/mgw-avatars.css?v=5&mvp19_4=illustrated-raster-roster-v5');", $mainCss, 'Main stylesheet must load the shared MVP-19.4 illustrated avatar owner');
