...
expect(manifest.includes('store-screen-checkers-board-source-wrapper.js?v=35') && manifest.includes('store-screen-checkers-wrapper.js?v=5') && manifest.includes('bundle_selector=preserve-v1') && manifest.includes('mvp19_6=visual-corrective-v3'), 'active runtime manifest must compose Store through the current Checkers corrective wrapper');
