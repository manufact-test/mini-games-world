...
expect(manifest.includes('store-screen-checkers-wrapper.js?v=3') && manifest.includes('mvp19_6=visual-corrective-v2'), 'active runtime manifest must compose Store through the current Checkers corrective wrapper');
