...
expect(manifest.includes('store-screen-checkers-wrapper.js?v=4') && manifest.includes('mvp19_6=visual-corrective-v3'), 'active runtime manifest must compose Store through the current Checkers corrective wrapper');
