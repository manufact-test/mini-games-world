...
$assertTrue(str_contains($storeModule, 'native:v11:component-v44') && str_contains($storeModule, 'data-mgw-domino-fx-v14') && str_contains($storeModule, 'data-mgw-domino-preview-component') && str_contains($storeModule, 'sceneReady'), 'Store must publish fresh live-v41 preview identity and reject stale scene markup');
...
$assertTrue(str_contains($storeOwner, "store-screen-domino-store-v1.js?v=11&mvp19_9=domino-preview-component-v44") && str_contains($storeOwner, "store-screen-domino-effects-v9.js?v=9&mvp19_9=domino-preview-component-v44"), 'Store owner must wire fresh live-v41 preview markup over accepted base geometry');
...
$assertTrue(str_contains($activeStore, 'domino_effects=component-v44') && str_contains($activeStore, 'domino_preview=component-v44') && str_contains($activeStore, 'domino_base=native-render-v2'), 'Active Store graph must publish live-v41 previews without changing the accepted base owner');
...
$assertTrue(str_contains($activeProfile, 'domino_effects=component-v44') && str_contains($activeProfile, 'domino_preview=shared-component-v44'), 'Active Profile graph must publish live-v41 parity');
$assertTrue(str_contains($dominoSource, 'store-screen-domino-store-v1.js?v=10') && str_contains($dominoCachedSource, 'store-screen-domino-store-v1.js?v=10') && str_contains($dominoProfile, 'mgw-profile-domino-parity.js?v=11'), 'Import map must cache-bust Store, cached base import and Profile to live-v41 sources');
$launchMatch = [];
