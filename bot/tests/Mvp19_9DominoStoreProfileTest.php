...
$assertTrue(str_contains($storeOwner, "store-screen-domino-store-v1.js?v=12&mvp19_9=domino-preview-motion-v46") && str_contains($storeOwner, "store-screen-domino-effects-v9.js?v=10&mvp19_9=domino-preview-motion-v46"), 'Store owner must wire fresh v44 preview markup over accepted base geometry');
...
$assertTrue(str_contains($activeStore, 'domino_effects=motion-v46') && str_contains($activeStore, 'domino_preview=motion-v46') && str_contains($activeStore, 'domino_base=native-render-v2'), 'Active Store graph must publish v44 previews without changing the accepted base owner');
...
$assertTrue(str_contains($activeProfile, 'domino_effects=motion-v46') && str_contains($activeProfile, 'domino_preview=shared-motion-v46'), 'Active Profile graph must publish v44 parity');
