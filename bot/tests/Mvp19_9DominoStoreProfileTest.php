...
$assertTrue(str_contains($storeOwner, "store-screen-reversi-store-v1.js?v=2&mvp19_7=store-only&selector=instant-active-v1") && str_contains($storeOwner, "store-screen-domino-store-v1.js?v=6&mvp19_9=domino-native-render-v6") && str_contains($storeOwner, "store-screen-domino-effects-v9.js?v=3&mvp19_9=domino-premium-effects-v11") && str_contains($storeOwner, 'installDominoStorePresentation();') && str_contains($storeOwner, 'upgradeDominoStorePresentation();'), 'Accepted Store owner must retain native Domino and load the stable selector plus premium effect graph');
