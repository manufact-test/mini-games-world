...
$assertTrue(str_contains($storeModule, 'native:v13:polish-v47') && str_contains($storeModule, 'data-mgw-domino-preview-component="v44"') && str_contains($storeModule, 'sceneReady'), 'Store must publish fresh v44 preview identity and reject stale scene markup');
...
$assertTrue(str_contains($baseStore, "store-screen-domino-store-v1.js?v=13&mvp19_9=domino-preview-polish-v47"), 'Base Store must directly import polished v47 instead of relying on wrapper repair');
...
$assertTrue(str_contains($storeOwner, "store-screen-domino-store-v1.js?v=13&mvp19_9=domino-preview-polish-v47") && str_contains($storeOwner, "store-screen-domino-effects-v9.js?v=11&mvp19_9=domino-preview-polish-v47"), 'Store owner must wire fresh v47 preview motion over accepted base geometry');
...
$assertTrue(str_contains($profileModule, "dominoPreviewMarkup } from '../screens/store-screen-domino-store-v1.js?v=13&mvp19_9=domino-preview-polish-v47'") && str_contains($profileModule, 'store-effects-scene-v9.css?v=7&mvp19_9=domino-premium-effects-v15-proportions') && str_contains($profileModule, 'store-effects-preview-component-v44.css?v=3&mvp19_9=domino-preview-polish-v47'), 'Profile must reuse the exact Store v47 preview source and component CSS');
...
echo "MVP-19.9 Domino Store/Purchase/Profile v47 polished preview contract passed ({$assertions} assertions).\n";
