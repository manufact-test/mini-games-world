...
$assertTrue(str_contains($storeModule, 'Костяшка влетает в цепь со световым шлейфом') && str_contains($storeModule, 'Костяшка поднимается из запаса в холодном свечении') && str_contains($storeModule, 'После последнего хода цепь вспыхивает золотым светом'), 'Domino effect descriptions must be simple customer-facing copy rather than technical choreography notes');
...
$assertTrue(!str_contains($effectCss, '.mgw-domino-fx-finale .mgw-domino-fx-rail') && !str_contains($effectCss, 'mgw-domino-v11-magnetic-glide') && !str_contains($effectCss, 'mgw-domino-v11-spectral-draw') && !str_contains($effectCss, 'mgw-domino-v11-lux-sheen'), 'Rejected v11 Finale rail and superseded choreography must be removed completely');
