...
$storeOuterEntry = (string)file_get_contents($root . '/app/assets/js/screens/store-screen-checkers-wrapper.js');
...
$assertTrue(str_contains($storeTarget, 'store-screen-checkers-wrapper.js?v=4') && str_contains($storeTarget, 'mvp19_6=visual-corrective-v3'), 'Active manifest may compose the mobile intent-only Store owner through the current Checkers Store corrective wrapper');
