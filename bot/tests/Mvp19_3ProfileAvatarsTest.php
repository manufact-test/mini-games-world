...
$assertTrue(str_contains($storeTarget, 'store-screen-checkers-wrapper.js?v=3') && str_contains($storeTarget, 'mvp19_6=visual-corrective-v2'), 'Active manifest may compose the mobile intent-only Store owner through the current Checkers Store corrective wrapper');
