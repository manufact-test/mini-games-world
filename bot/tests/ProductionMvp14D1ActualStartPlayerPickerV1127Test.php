...
$assert(
    str_contains($e2e, 'const APP_ROUTE = `${STAGING_ORIGIN}/app/v110.php?v=1123`;')
        && str_contains($e2e, "url.pathname.endsWith('/assets/js/games/game-invites-v110.js')")
    ...
    'The live regression must verify the retained inner v1130 owner rather than confusing it with the fresh outer v1132 publication.'
);
