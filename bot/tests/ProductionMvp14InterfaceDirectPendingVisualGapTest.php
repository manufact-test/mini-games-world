...
$assert(
    str_contains($shell, './games/game-invites-v110.js?v=1135&pending=3')
        && str_contains($main, './main-v110-handoff-shell.js?v=1135&pending=3')
        && str_contains($entry, './assets/js/main-v110.js?v=1135&pending=3'),
    'The passive-owner invite update must publish through a fresh cache-busted path while preserving the accepted v1135 graph identity.'
);
