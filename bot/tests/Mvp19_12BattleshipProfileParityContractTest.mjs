...
assert.ok(profile.includes("store-screen-battleship-store-v1.js?v=7&mvp19_12=store-preview-parity-v7&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&preview_geometry=inline-square-v3&hydration=observer-v1&inline_owner=v1&effects=unchanged-v2"), 'Profile must import the exact current Store preview owner');
...
assert.ok(layout.includes("mgw-profile-battleship-parity.js?v=7&mvp19_12=profile-four-parity-v3&store=preview-parity-v7&geometry=square&header=steel-ship&neon_fleet=tube-v4&preview_geometry=inline-square-v3&hydration=observer-v1&inline_owner=v1&effects=unchanged-v2&copy=four-pattern"), 'Active Profile owner must import Battleship Four-parity v3 with preview parity v7');
...
assert.ok(profileOwnerMatch && Number(profileOwnerMatch[1]) >= 34, 'Active Profile owner must bump the parent layout cache so preview parity v7 reaches clients');
assert.ok(manifest.includes('mgw-profile-chess-layout-v2.js?v=34') && manifest.includes('battleship_profile=four-parity-v3') && manifest.includes('battleship_store=preview-parity-v7') && manifest.includes('battleship_header=steel-ship-v1') && manifest.includes('battleship_neon_frame=outer-safe-v1') && manifest.includes('battleship_neon_fleet=tube-v4') && manifest.includes('battleship_preview_geometry=inline-square-v3') && manifest.includes('battleship_preview_inline_owner=v1'), 'Manifest must bump the parent Profile owner and publish inline preview parity v7');
