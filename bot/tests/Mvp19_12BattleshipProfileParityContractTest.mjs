...
assert.ok(profile.includes("store-screen-battleship-store-v1.js?v=10&mvp19_12=store-preview-parity-v10&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&fleet_preview=svg-models-v3&preview_geometry=svg-circles-v5&hydration=observer-v1&inline_owner=svg-v4&effects=unchanged-v2"), 'Profile must import the exact current Store SVG preview owner');
...
assert.ok(layout.includes("mgw-profile-battleship-parity.js?v=10&mvp19_12=profile-four-parity-v3&store=preview-parity-v10&geometry=square&header=steel-ship&neon_fleet=tube-v4&fleet_preview=svg-models-v3&preview_geometry=svg-circles-v5&hydration=observer-v1&inline_owner=svg-v4&effects=unchanged-v2&copy=four-pattern"), 'Active Profile owner must import Battleship Four-parity v3 with SVG preview parity v10');
...
assert.ok(profileOwnerMatch && Number(profileOwnerMatch[1]) >= 37, 'Active Profile owner must bump the parent layout cache so SVG preview parity v10 reaches clients');
assert.ok(manifest.includes('mgw-profile-chess-layout-v2.js?v=37') && manifest.includes('battleship_profile=four-parity-v3') && manifest.includes('battleship_store=preview-parity-v10') && manifest.includes('battleship_header=steel-ship-v1') && manifest.includes('battleship_neon_frame=outer-safe-v1') && manifest.includes('battleship_neon_fleet=tube-v4') && manifest.includes('battleship_preview_geometry=svg-circles-v5') && manifest.includes('battleship_preview_inline_owner=svg-v4') && manifest.includes('battleship_fleet_preview=svg-models-v3'), 'Manifest must bump the parent Profile owner and publish SVG preview parity v10');
