...
assert.ok(profile.includes("store-screen-battleship-store-v1.js?v=12&mvp19_12=store-preview-parity-v12&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&fleet_preview=svg-models-v3&neon_map_ships=white-v1&preview_geometry=svg-circles-v6&hydration=observer-v1&inline_owner=svg-v5&effects=live-parity-v1"), 'Profile must import the exact current Store SVG preview owner');
...
assert.ok(store.includes('data-battleship-effect-preview="accepted-live-parity-v1"'), 'Shared Store/Profile effect primitive must identify the accepted LIVE parity owner');
...
assert.ok(layout.includes("mgw-profile-battleship-parity.js?v=12&mvp19_12=profile-four-parity-v3&store=preview-parity-v12&geometry=square&header=steel-ship&neon_fleet=tube-v4&fleet_preview=svg-models-v3&neon_map_ships=white-v1&preview_geometry=svg-circles-v6&hydration=observer-v1&inline_owner=svg-v5&effects=live-parity-v1&copy=four-pattern"), 'Active Profile owner must import Battleship Four-parity v3 with SVG preview parity v11');
...
assert.ok(manifest.includes('mgw-profile-chess-layout-v2.js?v=39') && manifest.includes('battleship_profile=four-parity-v3') && manifest.includes('battleship_store=preview-parity-v12') && manifest.includes('battleship_header=steel-ship-v1') && manifest.includes('battleship_neon_frame=outer-safe-v1') && manifest.includes('battleship_neon_fleet=tube-v4') && manifest.includes('battleship_preview_geometry=svg-circles-v6') && manifest.includes('battleship_preview_inline_owner=svg-v5') && manifest.includes('battleship_fleet_preview=svg-models-v3&battleship_neon_map_ships=white-v1'), 'Manifest must bump the parent Profile owner and publish accepted effect preview parity v12');
assert.ok(launch.includes('battleship_profile=four-parity-v3') && launch.includes('battleship_store=preview-parity-v12') && launch.includes('battleship_effects=live-parity-v1'), 'Telegram launch must publish Battleship Profile and accepted effect-preview parity');
