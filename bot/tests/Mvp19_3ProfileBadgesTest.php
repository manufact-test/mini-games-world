...
$assertTrue(str_contains($cleanEntry, 'initMgwProfileBadges') && str_contains($cleanEntry, 'mgw-profile-badges.js?v=3&mvp19_3=profile-badge-avatar-overlay'), 'Active v110 clean entry must initialize the avatar-overlay badge presentation build');
$assertTrue(str_contains($mainCss, 'mgw-profile-badges.css?v=2&mvp19_3=profile-badge-avatar-overlay') && str_contains($manifest, 'mvp19_3_6=profile-badge-avatar-overlay'), 'Active v110 delivery graph must carry fresh avatar-overlay badge JS/CSS identities');
