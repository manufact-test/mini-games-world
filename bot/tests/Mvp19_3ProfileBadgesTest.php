...
$assertTrue(str_contains($mainCss, 'mgw-profile-badges.css?v=3&mvp19_3=profile-badge-avatar-demo') && str_contains($manifest, 'mvp19_3_8=badge-visual-polish'), 'Active v110 delivery graph must carry fresh badge demo JS/CSS identities');
