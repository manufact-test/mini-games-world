...
$assertTrue(str_contains($badgeSource, "String(players[index]?.badge_item_id") && str_contains($badgeSource, 'data.profileBadgeItemId'), 'Live player presentation must consume the canonical badge projection');
