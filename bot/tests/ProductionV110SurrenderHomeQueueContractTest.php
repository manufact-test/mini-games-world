...
$assert(
    str_contains($html, './assets/js/production-clean-entry-v110.js?v=1104')
        && str_contains($html, './assets/js/main-v110.js?v=1104')
        && str_contains($html, 'data-hotfix-build="v110-mvp14r3-surrender-home-queue"'),
    'The Telegram v110 entrypoint must publish the exact new browser build.'
);
...
$assert(
    ...
    'The production entry must initialize exactly one fresh surrender owner.'
);
