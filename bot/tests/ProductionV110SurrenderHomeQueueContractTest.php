...
$assert(
    str_contains($html, './assets/js/production-clean-entry-v110.js?v=1121')
        && str_contains($html, './assets/js/main-v110.js?v=1133')
        && str_contains($html, 'data-hotfix-build="v110-mvp14r12-terminal-dedup-v1133"'),
...
$assert(
    substr_count($entry, 'initV110MatchLifecycle();') === 1
        ...
        && str_contains($entry, "window.__MGW_REGRESSION_BUILD__ = 'v110-mvp14r12-terminal-dedup-v1133'"),
