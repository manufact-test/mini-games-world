...
$assertTrue(str_contains($outer, "store-screen-four-in-a-row-store-v1.js?v=4&four_store=static-v4"), 'Active Store wrapper must install Four in a Row presentation');
