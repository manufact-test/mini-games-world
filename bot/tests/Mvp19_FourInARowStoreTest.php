...
$assertTrue(str_contains($outer, "store-screen-four-in-a-row-store-v1.js?v=2&four_store=static-v2"), 'Active Store wrapper must install Four in a Row presentation');
...
$assertTrue(str_contains($activeStore, 'four_store=static-v2'), 'Active Store graph must publish static Four in a Row phase');
$launchMatch = [];
