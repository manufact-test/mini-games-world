...
$assertTrue(str_contains($outer, 'store-screen-battleship-store-v1.js?v=5&mvp19_12=store-preview-parity-v5&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&preview_geometry=square-grid-v2&effects=unchanged-v2'), 'Active Store wrapper must install Battleship preview parity v5 without rewriting accepted effect preview code');
$activeStore = (string)($manifest['imports']['./assets/js/screens/store-screen.js?v=34'] ?? '');
$assertTrue(str_contains($activeStore, 'store-screen-checkers-board-source-wrapper.js?v=25') && str_contains($activeStore, 'battleship_store=preview-parity-v5') && str_contains($activeStore, 'battleship_geometry=square') && str_contains($activeStore, 'battleship_header=steel-ship-v1') && str_contains($activeStore, 'battleship_neon_frame=outer-safe-v1') && str_contains($activeStore, 'battleship_neon_fleet=tube-v4') && str_contains($activeStore, 'battleship_preview_geometry=square-grid-v2') && str_contains($activeStore, 'battleship_effects=distinct-v2'), 'Active Store graph must bump the parent wrapper cache and publish preview parity v5');
$assertTrue(str_contains($launch, 'v=1227') && str_contains($launch, 'battleship_store=preview-parity-v5') && str_contains($launch, 'battleship_header=steel-ship-v1') && str_contains($launch, 'battleship_neon_frame=outer-safe-v1') && str_contains($launch, 'battleship_neon_fleet=tube-v4') && str_contains($launch, 'battleship_preview_geometry=square-grid-v2') && str_contains($launch, 'battleship_effects=distinct-v2'), 'Telegram launch must force a new graph and publish Store/Profile preview parity v5');
