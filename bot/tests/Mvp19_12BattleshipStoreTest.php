...
$assertTrue(str_contains($wrapper, 'data-battleship-effect-preview="accepted-live-parity-shot-v2"'), 'Shared Battleship preview owner must mark accepted LIVE parity');
...
$assertTrue(str_contains($outer, 'store-screen-battleship-store-v1.js?v=13&mvp19_12=store-preview-parity-v13&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&fleet_preview=svg-models-v3&neon_map_ships=white-v1&preview_geometry=svg-circles-v6&hydration=observer-v1&inline_owner=svg-v5&effects=live-parity-shot-v2'), 'Active Store wrapper must install Battleship accepted preview parity v12');
$activeStore = (string)($manifest['imports']['./assets/js/screens/store-screen.js?v=34'] ?? '');
$assertTrue(str_contains($activeStore, 'store-screen-checkers-board-source-wrapper.js?v=33') && str_contains($activeStore, 'battleship_store=preview-parity-v13') && str_contains($activeStore, 'battleship_geometry=square') && str_contains($activeStore, 'battleship_header=steel-ship-v1') && str_contains($activeStore, 'battleship_neon_frame=outer-safe-v1') && str_contains($activeStore, 'battleship_neon_fleet=tube-v4') && str_contains($activeStore, 'battleship_preview_geometry=svg-circles-v6') && str_contains($activeStore, 'battleship_store_hydration=observer-v1') && str_contains($activeStore, 'battleship_preview_inline_owner=svg-v5') && str_contains($activeStore, 'battleship_fleet_preview=svg-models-v3&battleship_neon_map_ships=white-v1') && str_contains($activeStore, 'battleship_effects=live-parity-shot-v2'), 'Active Store graph must publish SVG preview parity v11');
$assertTrue(str_contains($launch, 'v=1233') && str_contains($launch, 'battleship_store=preview-parity-v13') && str_contains($launch, 'battleship_header=steel-ship-v1') && str_contains($launch, 'battleship_neon_frame=outer-safe-v1') && str_contains($launch, 'battleship_neon_fleet=tube-v4') && str_contains($launch, 'battleship_preview_geometry=svg-circles-v6') && str_contains($launch, 'battleship_preview_inline_owner=svg-v5') && str_contains($launch, 'battleship_fleet_preview=svg-models-v3&battleship_neon_map_ships=white-v1') && str_contains($launch, 'battleship_effects=live-parity-shot-v2'), 'Telegram launch must force SVG preview parity v11');
