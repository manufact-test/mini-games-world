...
$assertTrue(str_contains($wrapper, "neon:'background:linear-gradient(145deg,#4d3aaa 0%,#2a205f 58%,#12152e 100%);border:2px solid #55f5ff") && str_contains($wrapper, 'inset 0 0 0 2px rgba(255,70,223,.34)'), 'Neon Fleet critical material must be embedded into shared markup instead of depending on external CSS delivery.');
...
$assertTrue(str_contains($outer, 'store-screen-battleship-store-v1.js?v=7&mvp19_12=store-preview-parity-v7&header=steel-ship&neon_frame=outer-safe&neon_fleet=tube-v4&preview_geometry=inline-square-v3&hydration=observer-v1&inline_owner=v1&effects=unchanged-v2'), 'Active Store wrapper must install Battleship preview parity v7 with inline critical visuals');
$activeStore = (string)($manifest['imports']['./assets/js/screens/store-screen.js?v=34'] ?? '');
$assertTrue(str_contains($activeStore, 'store-screen-checkers-board-source-wrapper.js?v=27') && str_contains($activeStore, 'battleship_store=preview-parity-v7') && str_contains($activeStore, 'battleship_geometry=square') && str_contains($activeStore, 'battleship_header=steel-ship-v1') && str_contains($activeStore, 'battleship_neon_frame=outer-safe-v1') && str_contains($activeStore, 'battleship_neon_fleet=tube-v4') && str_contains($activeStore, 'battleship_preview_geometry=inline-square-v3') && str_contains($activeStore, 'battleship_store_hydration=observer-v1') && str_contains($activeStore, 'battleship_preview_inline_owner=v1') && str_contains($activeStore, 'battleship_effects=distinct-v2'), 'Active Store graph must publish inline preview parity v7');
$assertTrue(str_contains($launch, 'v=1229') && str_contains($launch, 'battleship_store=preview-parity-v7') && str_contains($launch, 'battleship_header=steel-ship-v1') && str_contains($launch, 'battleship_neon_frame=outer-safe-v1') && str_contains($launch, 'battleship_neon_fleet=tube-v4') && str_contains($launch, 'battleship_preview_geometry=inline-square-v3') && str_contains($launch, 'battleship_preview_inline_owner=v1') && str_contains($launch, 'battleship_effects=distinct-v2'), 'Telegram launch must force inline preview parity v7');
