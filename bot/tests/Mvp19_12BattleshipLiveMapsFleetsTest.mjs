...
assert.ok(launch.includes('battleship_live=maps-fleets-v4') && launch.includes('battleship_frame=full-v1') && launch.includes('battleship_neon_fleet=tube-v4') && launch.includes('battleship_preview_geometry=svg-circles-v5') && launch.includes('battleship_preview_inline_owner=svg-v4') && launch.includes('battleship_fleet_preview=svg-models-v3'), 'Telegram launch must publish Battleship LIVE/SVG-preview parity identity');
