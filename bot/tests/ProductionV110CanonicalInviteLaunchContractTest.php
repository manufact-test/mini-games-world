...
$assert(
    ...
    'Start/menu and invite-message backends must depend on the fresh shared URL builder exactly once.'
);
...
$assert(
    ...
    'The active client must accept both Telegram start_param and canonical invite query tokens through one open_link action.'
);
