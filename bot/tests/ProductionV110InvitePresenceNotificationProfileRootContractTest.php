...
$assert(str_contains($shell, $build)
    ...
    'Every active outer entry owner must share the same final build identity.');
$assert(str_contains($main, 'main-v110-handoff-shell.js?v=1119')
    && str_contains($entry, 'production-clean-entry-v110.js?v=1119')
    && str_contains($entry, 'main-v110.js?v=1119')
    && str_contains($launch, '/app/v110.php?v=1119'),
    'Telegram launch and active modules must use the final outer revision.');
