...
$assert(str_contains($main, 'main-v110-handoff-shell.js?v=1121')
    ...
    'Telegram launch and active modules must use the clean canonical route and current statistics shell.');
