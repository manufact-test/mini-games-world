...
$assertTrue(str_contains($manifest, 'production-v100-entry-effects.css') && str_contains($manifest, 'entry_effects=1'), 'Active v110 manifest must cache-publish Entry Effects');
