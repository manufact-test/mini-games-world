...
final class ProductEconomyAnalyticsService
{
    ...
    public function snapshot(
        ...
        return [
            ...
            'coverage' => [
                'retention' => 'Показатель означает, что аккаунт был активен хотя бы раз после указанного срока с момента регистрации. Исторических событий по каждому календарному дню нет, поэтому это не классическое точное удержание D1/D7.',
                'matchmaking' => 'Историческая телеметрия ожидания хранится агрегатами. Старый трафик тестовой среды нельзя достоверно отделить задним числом; новые значения продолжают накапливаться в существующем владельце телеметрии.',
                ...
                'real_accounts' => 'Из продуктовых показателей исключаются технические аккаунты разработки и тестовые участники турниров; их исторические записи не удаляются.',
            ],
        ];
    }
