...
require_once __DIR__ . '/../ratings/SeasonCalendar.php';
require_once __DIR__ . '/../ratings/SeasonAssignmentResolver.php';
...
require_once __DIR__ . '/../economy/UnifiedBalanceMigrationRule.php';
