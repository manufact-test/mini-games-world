...
final class UserWelcomeGuard
{
    ...
    public function handle(array $update): bool
    {
        ...
        // Current authorized acceptance target: v111 shared match preparation and synchronized clocks.
        ...
        $baseWebAppUrl = rtrim((string)($this->config['base_url'] ?? ''), '/') . '/app/v111.php?v=111';
        if ($baseWebAppUrl === '/app/v111.php?v=111') return false;
