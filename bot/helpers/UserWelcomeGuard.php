...
final class UserWelcomeGuard
{
    ...
    public function handle(array $update): bool
    {
        ...
        // Retained no-store fallback entrypoint for rollback/manual diagnostics: /app/v103.php?v=103
        $baseWebAppUrl = rtrim((string)($this->config['base_url'] ?? ''), '/') . '/app/v104.php?v=104';
        if ($baseWebAppUrl === '/app/v104.php?v=104') return false;
