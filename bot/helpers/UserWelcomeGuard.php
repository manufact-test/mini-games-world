...
final class UserWelcomeGuard
{
    ...
    public function handle(array $update): bool
    {
        ...
        $webAppUrl = rtrim((string)($this->config['base_url'] ?? ''), '/') . '/app/?v=67';
        if ($webAppUrl === '/app/?v=67') return false;
        ...
        $this->telegram->api('sendMessage', [
            ...
            'reply_markup' => ['inline_keyboard' => [[['text' => '🎮 Начать игру','web_app' => ['url' => $webAppUrl]]]]],
