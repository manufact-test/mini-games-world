...
final class WebAppLaunchUrl
{
    ...
    private const ENTRY_PATH = '/app/v110.php?v=1207&domino_stability=30&runtime_fix=1&four_store=static-v6&paid_default=dedup-v2&four_profile=spacing-v2&four_module=export-v8&four_live=game-v6&four_drop=target-lock-no-base-flash-v2&four_effect2=random-chain-v4&four_victory_test=1&copy=human-v1';
