...
final class WebAppLaunchUrl
{
    ...
    private const ENTRY_PATH = '/app/v110.php?v=1203&domino_stability=30&runtime_fix=1&four_store=static-v5&paid_default=dedup-v2&four_profile=spacing-v2&four_module=export-v7&four_live=game-v2&four_effect2=pulse-v2&copy=human-v1';
