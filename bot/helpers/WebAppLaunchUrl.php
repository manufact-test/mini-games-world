...
final class WebAppLaunchUrl
{
    ...
    private const ENTRY_PATH = '/app/v110.php?v=1211&domino_stability=30&runtime_fix=1&four_store=live-previews-v1&paid_default=dedup-v2&four_profile=live-previews-v1&four_module=export-v9&four_live=game-v9&four_drop=target-lock-no-base-flash-v2&four_effect2=random-chain-v4&four_victory=overdrive-base-flash-v2&copy=player-v2';
