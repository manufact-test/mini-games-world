...
final class WebAppLaunchUrl
{
    ...
    private const ENTRY_PATH = '/app/v110.php?v=1214&domino_stability=30&runtime_fix=1&four_store=live-previews-v3&paid_default=dedup-v2&four_profile=live-previews-v3&four_module=export-v11&four_live=game-v10&four_drop=target-lock-no-base-flash-v2&four_effect2=random-chain-v4&four_victory=overdrive-base-flash-v2&copy=compact-v3&four_geometry=7x6&four_fx=victory-test-exact-v3&four_victory_test=1';
