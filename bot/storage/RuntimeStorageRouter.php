...
final class RuntimeStorageRouter
{
    ...
    public function enabledModules(): array
    {
        ...
        foreach (self::MODULES as $module) {
            if ($this->routeFor($module) === self::DRIVER_DATABASE) {
                $enabled[] = $module;
            }
        }
        return $enabled;
    ...
    private function validate(): void
    {
        ...
        if (!is_array($settings)) {
            throw new RuntimeException('database_runtime must be an array.');
        }
    ...
    private function boolValue(mixed $value, bool $strict = false): bool
    {
        ...
        if ($strict) {
            throw new RuntimeException('database_runtime module values must be boolean-like.');
        }
        return false;
    }
}
