...
if (!/main\.css\?v=\d+&sk=3&icons=c1efd5af&render=\d+&mvp16=(?:setup-subtitle-width|variant-rules-nav-balance|optical-bottom-nav|painted-bottom-nav|final-bottom-nav|final-bottom-nav-align)/u.test(clientManifest)) {
